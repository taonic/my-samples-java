...
// */
//
//package io.temporal.samples.autoturner;
//
...
//                Thread.sleep(seconds * 2000 + random.nextInt(100));
...
//            .setWorkerTuner(
//                ResourceBasedTuner.newBuilder().setControllerOptions(
//                    ResourceBasedControllerOptions.newBuilder(0.8/* target memory usage */, 0.8/* target CPU usage */).build()
//                ).build()
//            ).build();
