...
public class ApprovalActivitiesImpl implements ApprovalActivities {
    ...
    @Override
    public void migrateWorkflow(String namespace, String taskQueue, ApprovalTypes.WorkflowState state) {
        ...
        MigratedApprovalWorkflow workflow = client.newWorkflowStub(
