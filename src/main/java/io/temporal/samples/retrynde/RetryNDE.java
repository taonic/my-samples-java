...
public class RetryNDE implements Runnable {
    ...
    private static final Logger log =
            LoggerFactory.getLogger(RetryNDE.class);
    ...
    private static WorkflowClient runWorker() throws FileNotFoundException, SSLException {
        ...
        WorkflowImplementationOptions options =
                WorkflowImplementationOptions.newBuilder()
                        ...
                        .build();
        worker.registerWorkflowImplementationTypes(options, RetryNDE.RetryNDEWorkflowImpl.class);
        factory.start();
        return client;
    }
    ...
    public static void main(String[] args) {
        new CommandLine(new RetryNDE()).execute(args);
    }
}
